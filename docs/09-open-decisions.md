...
<!--g1:case_target-->543<!--/g1--> 義務のうち **`BROWSER` が <!--g1:tb_browser-->216<!--/g1--> 件**あるため **Full Profile は無人 CI で回せない**。
矛盾を残さないよう範囲を分ける。
...
| **Full Profile** | 全 <!--g1:case_target-->543<!--/g1--> 義務 | **必要**。手動実行し、固定サンプルとして公開する |

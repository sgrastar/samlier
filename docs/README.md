...
| `tests/coverage.yaml` | **要件カタログ＝判定レベルの唯一の出典**。<!--g1:requirements-->69<!--/g1--> 要件 → **<!--g1:obligations-->343<!--/g1--> 義務**（うち <!--g1:multi_clause-->41<!--/g1--> は複数範囲の `source_clauses`） |
...
M0   骨格実装            G1b 後に着手してよい（Test Peer / Transcript / Preflight。テスト 0 件）
  ↓
G2   テスト設計          ⏳ <!--g1:case_target-->342<!--/g1--> 義務をケース ID に割り当て、対照ケース・反例・mutant を定義

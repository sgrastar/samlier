...
import org.samlier.saml.normal.SamlInvalidRequestFactory;
import org.samlier.saml.normal.SamlInvalidRequestFactory.Fixture;
...
public final class IdpInvalidRequestScenarioTestCase
    ...
    @Override public String browserInstructionsEn() {
        return id.equals(STATUS_CASE)
                ? "Log in for the valid control. Samlier then sends schema-invalid and unsupported-version requests and checks any correlated SAML status automatically."
                : "Log in for the valid control. Samlier then sends an AuthnRequest without ID and checks any returned Response for an absent InResponseTo value.";
    }

...
public final class IdpForceAuthnScenarioTestCase
    ...
    @Override public String browserInstructionsEn() {
        return "Start with no target session and log in for the control. Samlier then runs omitted and explicit false controls. For ForceAuthn=true, complete the target's fresh authentication action; Samlier compares the correlated AuthnStatement timestamps. Do not enter a verdict.";
    }

...
import org.samlier.saml.normal.SamlRequestedAuthnContextRequestFactory.Fixture;
...
public final class IdpAuthnContextScenarioTestCase
    ...
    @Override public String browserInstructionsEn() {
        return "Perform login when requested. Samlier sends exact ClassRef, DeclRef, and unsatisfiable "

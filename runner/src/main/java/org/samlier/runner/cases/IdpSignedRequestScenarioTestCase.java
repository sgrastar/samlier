...
import org.samlier.saml.normal.SamlSignedRequestFactory;
import org.samlier.saml.normal.SamlSignedRequestFactory.Fixture;
...
public final class IdpSignedRequestScenarioTestCase
    ...
    @Override public String browserInstructionsEn() {
        return "Log in for the valid XML-signed AuthnRequest control. Samlier then sends content-tampered, reference-tampered, and SignatureValue-tampered requests. It derives the outcome from correlated Responses and target-generated signature algorithms; do not enter a verdict.";
    }

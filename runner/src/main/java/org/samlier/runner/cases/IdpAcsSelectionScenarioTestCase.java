...
import org.samlier.saml.normal.SamlAcsSelectionRequestFactory;
import org.samlier.saml.normal.SamlAcsSelectionRequestFactory.Fixture;
...
public final class IdpAcsSelectionScenarioTestCase
    ...
    @Override public String browserInstructionsEn() {
        return "Start the ACS selection scenario and log in when the target asks. Samlier compares the correlated "
